game.PlayScreen = me.ScreenObject.extend({
  ...
  // Add a resize method to update element positions on screen resize
  resize: function () {
    // Update ground positions
    this.ground1.pos.set(0, me.game.viewport.height - 96);
    this.ground2.pos.set(me.game.viewport.width, me.game.viewport.height - 96);

    // Update bird position
    this.bird.pos.set(60, me.game.viewport.height / 2 - 100);

    // Update get ready message position (if it still exists)
    if (this.getReady) {
      this.getReady.pos.set(
        me.game.viewport.width / 2,
        me.game.viewport.height / 2
      );
    }

    // You might need to update positions of other elements here too
  },
